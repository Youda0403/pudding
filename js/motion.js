...
(function (global) {
  ...
  var MOTIONS = {
    // 대기: 숨 쉬듯 말랑말랑
    idle: { frames: 40, delay: 80 },
    // 탱글: 톡 쳤을 때의 감쇠 진동
    jiggle: { frames: 50, delay: 60 }
  };
  ...
  function squashPose(squash, skewX) {
    return {
      skewX: skewX,
      scaleX: 1 - squash * 0.6,
      scaleY: 1 + squash
  ...
  function idlePose(t) {
    ...
    return squashPose(IDLE_SQUASH * w, IDLE_SWAY * Math.sin(TAU * t));
  }
  ...
  function poseFor(motion, f, dir) {
    ...
    return motion === 'jiggle' ? jigglePose(t, dir) : idlePose(t);
  }
